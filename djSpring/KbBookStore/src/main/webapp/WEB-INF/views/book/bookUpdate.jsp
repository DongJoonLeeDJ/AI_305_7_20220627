		...
		<div class="container">
			<form method="post" role="form" autocomplete="off"
				...
				<div class="row">
					...
					<div class="col-4">
						<input class="form-control" placeHolder="책 제목" name="bookname" value="${data.bookname }"></input>
					</div>
					<div class="col-4"></div>
				</div>
				<div class="row">
					...
					<div class="col-4">
						<input class="form-control" placeHolder="Isbn" name="bookisbn" value="${data.bookisbn }"></input>
					</div>
					<div class="col-4"></div>
				</div>
				<div class="row">
					...
					<div class="col-4">
						<input class="form-control" placeHolder="출판사" name="publisher" value="${data.publisher }"></input>
					</div>
					<div class="col-4"></div>
				</div>
				<div class="row">
					...
					<div class="col-4">
						<input class="form-control" placeHolder="가격" name="bookprice" value="${data.price }"></input>
					</div>
					<div class="col-4"></div>
				</div>
				<div class="row">
					...
					<div class="col-4">
						...
						<input type="file" class="form-control" name="bookImg" accept="image/png,image/jpeg,image/jpg"></input>
					</div>
					<div class="col-4"></div>
				</div>
				<div class="row">&nbsp;</div>
