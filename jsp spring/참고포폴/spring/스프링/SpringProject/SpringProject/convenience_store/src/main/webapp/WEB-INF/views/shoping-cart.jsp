		...
		<div class="humberger__menu__widget">
			...
			<div class="header__top__right__auth">
					<c:if test="${empty sessionScope.member2 }">
									<a class = "login" href="Member/login"><i class="fa fa-user"></i>Login 비어있다</a>
								</c:if>
									<% 
...
// 	 									out.println(mvo.getName());
                                ...
                                <c:if test = "${not empty sessionScope.member2 }">
                               		<a class = "login" href="#"><i class="fa fa-user"></i>LogOut</a>
								</c:if>
			</div>
		</div>
...
<%-- 								<c:forEach items="${list}" var="basket">
									<tr>
										<td class="shoping__cart__item"><!-- <img
											...
											<h5>${basket.pd_name}</h5></td>
										<td class="shoping__cart__price">${basket.pd_price}</td>
										...
										<td class="shoping__cart__total">${basket.money}</td>
									...
									<tr>
										...
										<td class="shoping__cart__total">$60.00</td>
										<td class="shoping__cart__item__close"><span
											class="icon_close"></span></td>
									</tr>
																		<tr>
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="shoping__checkout">
						<h5>Cart Total</h5>
						<ul>
							<li>Subtotal <span>$60.00</span></li>
							<li>Total <span>$60.00</span></li>
						</ul>

						<a href="javascript:void(0);" class="primary-btn" onclick="dopay()">PROCEED TO CHECKOUT</a>
					</div>
				</div>
			</div>
		</div>
	...
	function dopay(){
		$(function(){
	        ...
	        IMP.request_pay({
	            ...
	            name : '결제',
	            amount : '10000',
	            buyer_email : 'dron512@naver.com',
	            buyer_name : '박명회',
	            buyer_tel : '01099462662',
	            buyer_addr : '대구광역시동구동부로121경북산업',
