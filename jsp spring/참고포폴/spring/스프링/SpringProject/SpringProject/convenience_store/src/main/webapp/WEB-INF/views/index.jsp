<%@ page import="com.store.gdgd.member.MemberVO"%>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__right">
                            ...
                            <div class="header__top__right__auth">
								<c:if test="${empty sessionScope.member2 }">
									<a class = "login" href="Member/login"><i class="fa fa-user"></i>Login</a>
								</c:if>
									<% 
// 										MemberVO mvo = (MemberVO)session.getAttribute("member2");
// 										out.println("ssss = ");
// 										out.println(mvo);
// 	 									out.println(mvo.getName());
									%>                                
                                <c:if test = "${not empty sessionScope.member2 }">
                               		<a class = "login" href="/logout"><i class="fa fa-user"></i>LogOut</a>
								</c:if>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        <ul>
                            ...
                            <li><a href="#" onclick="dosavecart()"><i class="fa fa-shopping-bag"></i> <span>3</span></a></li>
                        </ul>
                    ...
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="./resources/img/featured/feature-1.jpg">
                            <ul class="featured__item__pic__hover">
                                ...
                                <li><a href="javascript:void(0);" onclick="dosavecart()"><i class="fa fa-shopping-cart"></i></a></li>
                            </ul>
                        </div>
...
<!--     Js Plugins
	...
	<script type="text/javascript">
		function dosavecart(){
			...
			var c_id = '${sessionScope.member2.id}';
			if (c_id=='')
			{
				alert('로그인하시고 장바구니에 담을 수 있습니다.')
				return ;
			}
